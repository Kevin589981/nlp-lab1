...
class Config:
    ...
    # 特殊token定义（用于分隔对话和摘要）
    dialogue_start = "Please summarize the following dialogue:\n\nDialogue:\n"  # 对话开始标记
    summary_start = "summary:"     # 摘要开始标记
    ...
    temperature = 1.0           # 生成温度（1.0=无变化，<1.0=更确定，>1.0=更随机）
